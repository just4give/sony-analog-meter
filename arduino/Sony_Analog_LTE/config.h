...
#define EI_API_KEY "ei_xxxxx" // replace with your API key
#define BROKER_NAME "xxxx-ats.iot.us-east-1.amazonaws.com"
#define BROKER_PORT  8883               // port 8883 is the default for MQTT over TLS or 1883 for non-TLS.
#define MQTT_TOPIC   "spresense" // replace with your topic
